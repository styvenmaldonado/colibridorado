  ...
  <div class="flex flex-col w-screen h-screen">
    ...
    <div
      ...
      <div class="px-5 w-full lg:w-11/12 lg:py-8">
        ...
        <div class="mt-8 grid grid-col-1 gap-2 py-2 px-3 w-full bg-gray-200 rounded-lg">
          ...
          <div class="flex flex-col">
            ...
            <span>{{ data?.data?.amount_in_cents }} {{ data?.data?.currency }}</span>
          </div>
          <div class="flex flex-col">
          ...
          <spa> <span>{{ data?.data?.reference }}</span></spa>
        </div>
      </div>
      <div class="px-5 py-6 ">
        <button type="submit" @click="navigateTo('/schedule-interview')"

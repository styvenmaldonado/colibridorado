...
<template>
    <div v-if="status == 'pending' || loading" style="z-index:9999" class="fixed w-screen h-screen bg-gray-600 opacity-45 flex">
          ...
          <template v-slot:item.1>
            <v-form @submit.prevent="nextStep" class="pt-4 flex flex-col">
              ...
              <v-select
                ...
                variant="outlined"
                model-value="Caminantes Acostad@s"
                :items="[

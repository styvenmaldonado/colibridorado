...
<template>
  <div class="flex flex-col w-screen h-screen">
    ...
    <div
      ...
      <div class="px-5 lg:w-11/12 lg:py-8 mx-auto">
        ...
        <v-form @submit.prevent="onSubmit" class="pt-4 flex flex-col gap-y-2">
          ...
          <button
            class="bg-gradient-to-r from-fuchsia-900 to-violet-950 text-white font-bold py-4 w-full rounded-lg">Inicia
            el vuelo</button>
    ...
    <div class="flex h-40">
      <div class="m-auto">¿Aún no tienes cuenta? <NuxtLink class="text-fuchsia-900 font-bold" to="/registrate">
          Registrate</NuxtLink>
      </div>
    </div>
  </div>
